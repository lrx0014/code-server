...
[![Publish Helm Chart](https://github.com/lrx0014/code-server/actions/workflows/publish_helm_chart.yml/badge.svg?branch=main)](https://github.com/lrx0014/code-server/actions/workflows/publish_helm_chart.yml)
